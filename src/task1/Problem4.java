...
public class Problem4 {
	...
	public static void main(String[] args) {
		// Problem 4: Given an array of integers and a number k, write a function to determine if there are two distinct elements in the array that add up to k and both elements should be even number.
